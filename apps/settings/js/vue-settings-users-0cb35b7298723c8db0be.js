    ...
    sendWelcomeMail: {
      ...
      async set(value) {
        try {
          ...
          await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_8___default.a.post(Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_10__["generateUrl"])('/settings/users/preferences/newUser.sendEmail'), {
            value: value ? 'yes' : 'no'
          });
        } catch (e) {
  ...
  methods: {
    showNewUserMenu() {
      ...
      if (this.showConfig.showNewUserForm) {
        vue__WEBPACK_IMPORTED_MODULE_12__["default"].nextTick(() => {
...
//# sourceMappingURL=vue-settings-users-0cb35b7298723c8db0be.js.map?v=18124f3cf225b708f3dc